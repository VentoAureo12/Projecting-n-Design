...
namespace WpfApp1
{
    ...
    public partial class Cпортсмен
    {
        ...
        public Cпортсмен()
        {
            ...
            this.Таблица_результатов = new HashSet<Таблица_результатов>();
        }
    
        public int Код_спортсмена { get; set; }
        ...
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Usage", "CA2227:CollectionPropertiesShouldBeReadOnly")]
        public virtual ICollection<Таблица_результатов> Таблица_результатов { get; set; }
    }
}
